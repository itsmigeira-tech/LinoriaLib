...
-- library functions 
	...
	-- elements 
		...
		function library:window(properties)
			...
			-- ESP Preview auxiliary panel. It starts hidden and is opened from Configuration.
				...
				local esp_column = setmetatable(esp_items, library):column()
				window.esp_section = esp_column:section({name = "Main"})
				window.esp_widget = esp_holder

				function window.set_esp_preview_visible(bool)
					esp_holder.set_visible(bool)
				end

				function window.toggle_esp_preview()
					esp_holder.toggle()
				end
			...
			-- Configuration is now a normal main-window tab.
				function window.configuration_tab()
					if window._configuration_tab then
						return window._configuration_tab
					end

					local configuration = library.tab(window, {name = "Configuration"})
					window._configuration_tab = configuration
					...
					section:toggle({
						name = "ESP Preview",
						flag = "esp_preview_widget",
						callback = function(bool)
							window.set_esp_preview_visible(bool)
						end,
					})
